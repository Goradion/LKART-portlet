...
public class LearnProgressPersistenceImpl extends BasePersistenceImpl<LearnProgress>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_USERIDANDCARDBOXID =
		new FinderPath(LearnProgressModelImpl.ENTITY_CACHE_ENABLED,
			LearnProgressModelImpl.FINDER_CACHE_ENABLED,
			LearnProgressImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByUserIdAndCardBoxId",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_USERIDANDCARDBOXID =
		new FinderPath(LearnProgressModelImpl.ENTITY_CACHE_ENABLED,
			LearnProgressModelImpl.FINDER_CACHE_ENABLED,
			LearnProgressImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByUserIdAndCardBoxId",
			...
			LearnProgressModelImpl.USERID_FK_COLUMN_BITMASK |
			LearnProgressModelImpl.CARDBOXID_FK_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_USERIDANDCARDBOXID = new FinderPath(LearnProgressModelImpl.ENTITY_CACHE_ENABLED,
			LearnProgressModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByUserIdAndCardBoxId",
			new String[] { Long.class.getName(), Long.class.getName() });
	 ...
	 */
	@Override
	public List<LearnProgress> findByUserIdAndCardBoxId(long userId_fk,
		long cardBoxId_fk) {
		return findByUserIdAndCardBoxId(userId_fk, cardBoxId_fk,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<LearnProgress> findByUserIdAndCardBoxId(long userId_fk,
		...
		return findByUserIdAndCardBoxId(userId_fk, cardBoxId_fk, start, end,
			null);
	}
	...
	public List<LearnProgress> findByUserIdAndCardBoxId(long userId_fk,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_USERIDANDCARDBOXID;
			finderArgs = new Object[] { userId_fk, cardBoxId_fk };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_USERIDANDCARDBOXID;
			finderArgs = new Object[] {
					userId_fk, cardBoxId_fk,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (LearnProgress learnProgress : list) {
					if ((userId_fk != learnProgress.getUserId_fk()) ||
							(cardBoxId_fk != learnProgress.getCardBoxId_fk())) {
						list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_USERIDANDCARDBOXID_USERID_FK_2);

			query.append(_FINDER_COLUMN_USERIDANDCARDBOXID_CARDBOXID_FK_2);
	 ...
	 */
	@Override
	public LearnProgress findByUserIdAndCardBoxId_First(long userId_fk,
		long cardBoxId_fk, OrderByComparator<LearnProgress> orderByComparator)
		throws NoSuchLearnProgressException {
		LearnProgress learnProgress = fetchByUserIdAndCardBoxId_First(userId_fk,
	 ...
	 */
	@Override
	public LearnProgress fetchByUserIdAndCardBoxId_First(long userId_fk,
		long cardBoxId_fk, OrderByComparator<LearnProgress> orderByComparator) {
		List<LearnProgress> list = findByUserIdAndCardBoxId(userId_fk,
				cardBoxId_fk, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public LearnProgress findByUserIdAndCardBoxId_Last(long userId_fk,
		long cardBoxId_fk, OrderByComparator<LearnProgress> orderByComparator)
		throws NoSuchLearnProgressException {
		LearnProgress learnProgress = fetchByUserIdAndCardBoxId_Last(userId_fk,
				cardBoxId_fk, orderByComparator);
	 ...
	 */
	@Override
	public LearnProgress fetchByUserIdAndCardBoxId_Last(long userId_fk,
		long cardBoxId_fk, OrderByComparator<LearnProgress> orderByComparator) {
		int count = countByUserIdAndCardBoxId(userId_fk, cardBoxId_fk);
		...
		List<LearnProgress> list = findByUserIdAndCardBoxId(userId_fk,
				cardBoxId_fk, count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public LearnProgress[] findByUserIdAndCardBoxId_PrevAndNext(long id,
		...
		try {
			...
			array[0] = getByUserIdAndCardBoxId_PrevAndNext(session,
					learnProgress, userId_fk, cardBoxId_fk, orderByComparator,
					true);

			array[1] = learnProgress;

			array[2] = getByUserIdAndCardBoxId_PrevAndNext(session,
					learnProgress, userId_fk, cardBoxId_fk, orderByComparator,
					false);
	...
	protected LearnProgress getByUserIdAndCardBoxId_PrevAndNext(
		Session session, LearnProgress learnProgress, long userId_fk,
		long cardBoxId_fk, OrderByComparator<LearnProgress> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByUserIdAndCardBoxId(long userId_fk, long cardBoxId_fk) {
		for (LearnProgress learnProgress : findByUserIdAndCardBoxId(userId_fk,
				cardBoxId_fk, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(learnProgress);
		}
	}
	 ...
	 */
	@Override
	public int countByUserIdAndCardBoxId(long userId_fk, long cardBoxId_fk) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_USERIDANDCARDBOXID;

		Object[] finderArgs = new Object[] { userId_fk, cardBoxId_fk };
	...
	private static final String _FINDER_COLUMN_USERIDANDCARDBOXID_USERID_FK_2 = "learnProgress.userId_fk = ? AND ";
	private static final String _FINDER_COLUMN_USERIDANDCARDBOXID_CARDBOXID_FK_2 =
		"learnProgress.cardBoxId_fk = ?";
	...
	public LearnProgress updateImpl(LearnProgress learnProgress) {
		...
		if (isNew || !LearnProgressModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((learnProgressModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_USERIDANDCARDBOXID.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						learnProgressModelImpl.getOriginalUserId_fk(),
						learnProgressModelImpl.getOriginalCardBoxId_fk()
					};

				finderCache.removeResult(FINDER_PATH_COUNT_BY_USERIDANDCARDBOXID,
					args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_USERIDANDCARDBOXID,
					args);

				args = new Object[] {
						learnProgressModelImpl.getUserId_fk(),
						learnProgressModelImpl.getCardBoxId_fk()
					};
