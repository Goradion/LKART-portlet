...
public class CardBoxUtil {
	...
	* @return the matching card boxs
	*/
	public static List<CardBox> findByForeignAndShared(long userId) {
		return getPersistence().findByForeignAndShared(userId);
	}
	...
	* @return the range of matching card boxs
	*/
	public static List<CardBox> findByForeignAndShared(long userId, int start,
		int end) {
		return getPersistence().findByForeignAndShared(userId, start, end);
	}
	...
	*/
	public static List<CardBox> findByForeignAndShared(long userId, int start,
		...
		return getPersistence()
				   .findByForeignAndShared(userId, start, end, orderByComparator);
	}
	...
	*/
	public static List<CardBox> findByForeignAndShared(long userId, int start,
		...
		boolean retrieveFromCache) {
		return getPersistence()
				   .findByForeignAndShared(userId, start, end,
	...
	* @throws NoSuchCardBoxException if a matching card box could not be found
	*/
	public static CardBox findByForeignAndShared_First(long userId,
		OrderByComparator<CardBox> orderByComparator)
		throws de.ki.sbamdc.exception.NoSuchCardBoxException {
		return getPersistence()
				   .findByForeignAndShared_First(userId, orderByComparator);
	}
	...
	* @return the first matching card box, or <code>null</code> if a matching card box could not be found
	*/
	public static CardBox fetchByForeignAndShared_First(long userId,
		OrderByComparator<CardBox> orderByComparator) {
		return getPersistence()
				   .fetchByForeignAndShared_First(userId, orderByComparator);
	}
	...
	* @throws NoSuchCardBoxException if a matching card box could not be found
	*/
	public static CardBox findByForeignAndShared_Last(long userId,
		OrderByComparator<CardBox> orderByComparator)
		throws de.ki.sbamdc.exception.NoSuchCardBoxException {
		return getPersistence()
				   .findByForeignAndShared_Last(userId, orderByComparator);
	}
	...
	* @return the last matching card box, or <code>null</code> if a matching card box could not be found
	*/
	public static CardBox fetchByForeignAndShared_Last(long userId,
		OrderByComparator<CardBox> orderByComparator) {
		return getPersistence()
				   .fetchByForeignAndShared_Last(userId, orderByComparator);
	}
	...
	* @throws NoSuchCardBoxException if a card box with the primary key could not be found
	*/
	public static CardBox[] findByForeignAndShared_PrevAndNext(long id,
		long userId, OrderByComparator<CardBox> orderByComparator)
		throws de.ki.sbamdc.exception.NoSuchCardBoxException {
		return getPersistence()
				   .findByForeignAndShared_PrevAndNext(id, userId,
			orderByComparator);
	}
	...
	* @param userId the user ID
	*/
	public static void removeByForeignAndShared(long userId) {
		getPersistence().removeByForeignAndShared(userId);
	}
	...
	* @return the number of matching card boxs
	*/
	public static int countByForeignAndShared(long userId) {
		return getPersistence().countByForeignAndShared(userId);
	}
