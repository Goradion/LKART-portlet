...
public interface FlashcardPersistence extends BasePersistence<Flashcard> {
	...
	*/
	public Flashcard fetchByCardBoxIdAndTitle(long cardBoxId_fk,
	...
	*/
	public Flashcard removeByCardBoxIdAndTitle(long cardBoxId_fk,
		java.lang.String title) throws NoSuchFlashcardException;
	...
	* @return the number of matching flashcards
	*/
	public int countByCardBoxIdAndTitle(long cardBoxId_fk,
		java.lang.String title);
