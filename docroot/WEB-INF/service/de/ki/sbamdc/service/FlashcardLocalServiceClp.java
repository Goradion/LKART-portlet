...
public class FlashcardLocalServiceClp implements FlashcardLocalService {
	public FlashcardLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodName6 = "createFlashcard";

		_methodParameterTypes6 = new String[] { "long" };

		_methodName7 = "deleteFlashcard";

		_methodParameterTypes7 = new String[] { "de.ki.sbamdc.model.Flashcard" };

		_methodName8 = "deleteFlashcard";

		_methodParameterTypes8 = new String[] { "long" };

		_methodName9 = "fetchFlashcard";

		_methodParameterTypes9 = new String[] { "long" };

		_methodName10 = "getFlashcard";

		_methodParameterTypes10 = new String[] { "long" };

		_methodName11 = "updateFlashcard";

		_methodParameterTypes11 = new String[] { "de.ki.sbamdc.model.Flashcard" };

		_methodName12 = "getFlashcardsCount";
	...
	public java.util.List<de.ki.sbamdc.model.Flashcard> findByCardBoxId(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName18,
					_methodParameterTypes18, new Object[] { cardBoxId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
